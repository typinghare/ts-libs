 ...
 */
export type JsonFactoryClass<O = any, J = any> = new (factoryManager: FactoryManager, originalObject?: O) => JsonFactory<O, J>;
/**
 ...
 * @author James Chan
 */
export declare abstract class JsonFactory<O = any, J = any> {
    /**
