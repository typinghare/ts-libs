...
describe('Test SlowHourMinuteSecond.', function () {
    it('Test getting hours, minutes, and seconds.', function () {
        const hourMinuteSecond = new main_1.SlowHourMinuteSecond(4532500);
    ...
    it('Test consume and extend.', function () {
        const hourMinuteSecond = new main_1.SlowHourMinuteSecond(4532000);
    ...
    it('Test consume and extend using HourMinuteSecond.', function () {
        const hourMinuteSecond = new main_1.SlowHourMinuteSecond(4532000);
        hourMinuteSecond.extend(new main_1.SlowHourMinuteSecond(8245000));
        expect(hourMinuteSecond.hour).toBe(3);
        expect(hourMinuteSecond.minute).toBe(32);
        expect(hourMinuteSecond.second).toBe(57);
        hourMinuteSecond.consume(new main_1.SlowHourMinuteSecond(4040000));
    ...
    it('Test clone.', function () {
        const hourMinuteSecond = new main_1.SlowHourMinuteSecond(30030000);
    ...
    it('Test toString.', function () {
        expect(new main_1.SlowHourMinuteSecond(30008000).toString()).toBe('08:20:08');
        expect(new main_1.SlowHourMinuteSecond(387000).toString()).toBe('00:06:27');
    });
    it('Test of.', function () {
        expect(main_1.SlowHourMinuteSecond.ofSeconds(100).second).toBe(40);
        expect(main_1.SlowHourMinuteSecond.ofMinutes(50).minute).toBe(50);
        expect(main_1.SlowHourMinuteSecond.ofHours(10).hour).toBe(10);
    });
});
