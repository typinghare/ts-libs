...
describe('Test QuickHourMinuteSecond.', function () {
    it('Test getting hours, minutes, and seconds.', function () {
        const hourMinuteSecond = new main_1.QuickHourMinuteSecond(4532500);
    ...
    it('Test consume and extend.', function () {
        const hourMinuteSecond = new main_1.QuickHourMinuteSecond(4532000);
    ...
    it('Test consume and extend using HourMinuteSecond.', function () {
        const hourMinuteSecond = new main_1.QuickHourMinuteSecond(4532000);
        hourMinuteSecond.extend(new main_1.QuickHourMinuteSecond(2, 17, 25));
        expect(hourMinuteSecond.hour).toBe(3);
        expect(hourMinuteSecond.minute).toBe(32);
        expect(hourMinuteSecond.second).toBe(57);
        hourMinuteSecond.consume(new main_1.QuickHourMinuteSecond(1, 7, 20));
    ...
    it('Test extendSecond, consumeMinute, and consumeHour.', function () {
        const hourMinuteSecond = new main_1.QuickHourMinuteSecond(8, 20, 30);
    ...
    it('Test toString.', function () {
        expect(new main_1.QuickHourMinuteSecond(8, 20, 8).toString()).toBe('08:20:08');
        expect(new main_1.QuickHourMinuteSecond(0, 6, 27).toString()).toBe('00:06:27');
    });
    it('Test of.', function () {
        expect(main_1.QuickHourMinuteSecond.ofSeconds(100).second).toBe(40);
        expect(main_1.QuickHourMinuteSecond.ofMinutes(50).minute).toBe(50);
        expect(main_1.QuickHourMinuteSecond.ofHours(10).hour).toBe(10);
    });
});
